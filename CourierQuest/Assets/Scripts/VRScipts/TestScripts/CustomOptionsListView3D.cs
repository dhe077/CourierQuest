...
public class CustomOptionsListView3D : DialogueViewBase
{
    ...
    public override void RunOptions(DialogueOption[] dialogueOptions, Action<int> onOptionSelected)
    {
        ...
        OptionView CreateNewOptionView()
        {
            ...
            // TEST
            GameObject testCubes = Instantiate(testCube);
            testCubes.transform.SetParent(transform, false);
            testCubes.transform.SetAsLastSibling();
